...
import YearAccordion from "./YearAccordion.jsx";
  ...
  return (
    <div className="edu-card">
      ...
      <div className="edu-bottom">
        ...
        <p><strong>Key Domains:</strong> Software Development, Systems & Architecture, Data Management, Artificial Intelligence, Cloud Technologies</p>
